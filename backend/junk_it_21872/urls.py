"""junk_it_21872 URL Configuration
...
admin.site.site_header = "Junk It"
admin.site.site_title = "Junk It Admin Portal"
admin.site.index_title = "Junk It Admin"

# swagger
api_info = openapi.Info(
    title="Junk It API",
    default_version="v1",
    description="API documentation for Junk It App",
)
